...
def read_raw_sentiment(tarfname):
    """
    Read complete sentiment raw documents, without any preprocessing.
    
    Available fields: ['train_data', 'train_labels', 'dev_data', 'dev_labels', 'le', 'target_labels', 'trainy', 'devy', 'unlabeled']
    """
    import tarfile
    tar = tarfile.open(tarfname, "r:gz")
    trainname = "train.tsv"
    ...
    unlabeled_documents = read_unlabeled(tarfname).data
    print(len(unlabeled_documents))
    sentiment.unlabeled = unlabeled_documents
